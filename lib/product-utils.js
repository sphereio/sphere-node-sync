...
*/
var actionsList, buildAddPriceAction, buildNewSetAttributeAction, buildRemovePriceAction, buildSetAttributeAction, helper, jsondiffpatch, _;
...
exports.ProductUtils = function() {};

exports.ProductUtils.prototype.diff = function(old_obj, new_obj) {
  var patchPrices;
...
exports.ProductUtils.prototype.actionsMap = function(diff, old_obj) {
  var actions;
  actions = [];
...
exports.ProductUtils.prototype.actionsMapPrices = function(diff, old_obj, new_obj) {
  var actions, prices;
  actions = [];
...
exports.ProductUtils.prototype.actionsMapAttributes = function(diff, new_obj) {
