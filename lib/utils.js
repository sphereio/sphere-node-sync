/* ===========================================================
# sphere-product-sync - v0.2.3
# ==============================================================
# Copyright (c) 2013 Nicola Molinari
# Licensed under the MIT license.
*/
var actionsList, buildAddPriceAction, buildNewSetAttributeAction, buildRemovePriceAction, buildSetAttributeAction, getDeltaValue, jsondiffpatch, _;
...
exports.Utils.prototype.diff = function(old_obj, new_obj) {
  var patchPrices;
...
exports.Utils.prototype.actionsMap = function(diff, old_obj) {
  var actions;
  actions = [];
...
exports.Utils.prototype.actionsMapPrices = function(diff, old_obj, new_obj) {
  var actions, prices;
  actions = [];
...
exports.Utils.prototype.actionsMapAttributes = function(diff, new_obj) {
      ...
      if (_.isString(diffed_value)) {
        ...
        if (_.isArray(lab)) {
          ...
          _.each(lab, function(v, k) {
            return label[k] = getDeltaValue(v);
          });
        }
        action.value = {
          label: label,
          key: getDeltaValue(diffed_value.key) || attribute.value.key
        };
