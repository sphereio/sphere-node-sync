...
InventorySync = (function(_super) {
  ...
  InventorySync.prototype.createInventoryEntry = function(sku, quantity, expectedDelivery, channelId) {
    var d;
    d = {
      sku: sku,
    ...
    if (expectedDelivery) {
      d.expectedDelivery = expectedDelivery;
    }
    if (channelId) {
      d.supplyChannel = {
        typeId: 'channel',
